...
import { MessageCircle, Repeat2, Heart, ExternalLink, CornerDownRight, Quote, Play } from 'lucide-react';
    ...
    <div className="p-2 hover:bg-accent/35 transition-colors duration-150">
      ...
      {embed && (
        <div className="ml-9 mb-1.5">
          ...
          {quotedRecord?.$type === 'app.bsky.embed.record#viewRecord' && (
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="block mt-1.5 border rounded-md p-2 bg-muted/25 hover:bg-accent/40 transition-colors"
            >
        ...
        <div className="text-[11px] line-clamp-3 whitespace-pre-wrap break-words leading-tight">
                {quotedRecord.value?.text || 'Quoted post'}
              </div>
            </a>
          )}
